<template>
    ...
    <section class="h-custom h-100">
        ...
        <div class="container py-5">
            ...
            <div class="col-5 m-auto"><img src="https://i5.walmartimages.com/dfw/63fd9f59-b3e1/7a569e53-f29a-4c3d-bfaf-6f7a158bfadd/v1/walmartLogo.svg" height="120px"/></div>
...
<script>
document.querySelector('body').style.backgroundColor="#0071DC"
