<template>
  ...
  <div class="d-flex align-items-center" style="background-color: rgb(230, 241, 252);height:972px;">
    <v-card class="mx-auto align-center" max-width="500">
        ...
        <v-window-item :value="3">
          <div class="pa-4 text-center">
            <v-img class="mb-4" contain height="128"
              src="https://imgs.search.brave.com/h4FY_hjbW6HgNyuC2Z6cwYu2XuHLJou328XNjVe2oQ4/rs:fit:800:710:1/g:ce/aHR0cHM6Ly9wcm9k/LWNkbi10aGVrcmF6/eWNvdXBvbmxhZHku/aW1naXgubmV0L3dw/LWNvbnRlbnQvdXBs/b2Fkcy8yMDE5LzEw/L3dhbG1hcnQtbG9n/by0xNTcyNTQ2Mjg2/LnBuZz9hdXRvPWNv/bXByZXNzLGZvcm1h/dCZmaXQ9bWF4">
            </v-img>
      ...
      <v-card-actions>
        <v-btn v-if="step !== 3" class="text-warning"
          :disabled="step === 1 || userData.password !== userData.password2" text @click="step--">
          Back
        </v-btn>
        <v-spacer></v-spacer>
        <v-btn v-if="step !== 3 && userData.password == userData.password2" :disabled="step === 3"
          class="btn-warning text-warning" depressed @click="step++, createUser(userData)">
          Next
        </v-btn>
      </v-card-actions>
    </v-card>
